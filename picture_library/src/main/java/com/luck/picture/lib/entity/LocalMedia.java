...
public class LocalMedia implements Parcelable {
    ...
    public void setIs_progress(boolean is_progress) {
        this.is_progress = is_progress;
    }


    public String getNew_path() {
        return (new_path!=null)?new_path:"";
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.new_path);
        dest.writeByte(this.is_progress ? (byte) 1 : (byte) 0);
    }
    ...
    protected LocalMedia(Parcel in) {
        ...
        this.new_path = in.readString();
        this.is_progress = in.readByte() != 0;
