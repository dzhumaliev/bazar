...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
                ...
                .subscribe(new Observer<Boolean>() {
                    ...
                    public void onNext(Boolean aBoolean) {
                        if (aBoolean) {
                            ...
                            readLocalMedia(savedInstanceState);
                        } else {
     ...
     * get LocalMedia s
     */
    protected void readLocalMedia(final Bundle savedInstanceState) {
...
if ((savedInstanceState == null) && selectionMedias.size() > 0) {
                        for (int i = 0; i < selectionMedias.size(); i++) {
                            if (selectionMedias.get(i).getPath().contains("http")) {
                                if (!images.contains(selectionMedias.get(i))) {
                                    images.add(i, selectionMedias.get(i));
                                }
                            }
    ...
    public void startOpenCamera() {
        ...
        if (cameraIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (cameraFile != null) {
                ...
                ToastManage.s(this, getString(R.string.picture_camera_error));
            }
