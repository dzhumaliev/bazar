...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        mStateTv.setCompoundDrawablesWithIntrinsicBounds( null,null, null, mCollapsed ? mExpandDrawable : mCollapseDrawable);
    ...
    private void findViews() {
       ...
       //mStateTv.setTextSize(1);
        mStateTv.setCompoundDrawablesWithIntrinsicBounds( null,null, null, mCollapsed ? mExpandDrawable : mCollapseDrawable);
        //mStateTv.setCompoundDrawablePadding(1);
