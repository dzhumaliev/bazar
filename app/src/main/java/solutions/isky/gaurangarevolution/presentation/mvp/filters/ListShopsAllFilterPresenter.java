...
@InjectViewState
public class ListShopsAllFilterPresenter extends BasePresenter<IShopView> {

    @Inject
    ServerMethod serverMethod;
    public ListShopsAllFilterPresenter() {
                ...
                .subscribe(getListPoster -> {
                    ...
                    if (getListPoster.getResult() > 0) {
                        ...
                        if (getListPoster.getMessage() != null && getListPoster.getMessage().size() > 0) {
                            ...
                            } else if(ErrorMessage.SHOPS_NOT_FOUND.equalsIgnoreCase(getListPoster.getMessage().get(0).getMsg())){
