package solutions.isky.gaurangarevolution.slider.library;
...
import solutions.isky.gaurangarevolution.slider.library.Animations.BaseAnimationInterface;
...
import solutions.isky.gaurangarevolution.slider.library.SliderTypes.TextSliderView;
import solutions.isky.gaurangarevolution.slider.library.Transformers.AccordionTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.BackgroundToForegroundTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.BaseTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.CubeInTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.DefaultTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.DepthPageTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.FadeTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.FlipHorizontalTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.FlipPageViewTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.ForegroundToBackgroundTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.RotateDownTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.RotateUpTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.StackTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.TabletTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.ZoomInTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.ZoomOutSlideTransformer;
import solutions.isky.gaurangarevolution.slider.library.Transformers.ZoomOutTransformer;
import solutions.isky.gaurangarevolution.slider.library.Tricks.FixedSpeedScroller;
import solutions.isky.gaurangarevolution.slider.library.Tricks.InfinitePagerAdapter;
import solutions.isky.gaurangarevolution.slider.library.Tricks.InfiniteViewPager;
import solutions.isky.gaurangarevolution.slider.library.Tricks.ViewPagerEx;
import solutions.isky.gaurangarevolution.slider.library.utils.SliderInfo;
...
//            mResumingTimer.schedule(mResumingTask, 6000);
    ...
    public void refreshSlider(List<SliderInfo> datas, BaseSliderView.OnSliderClickListener listener) {
        ...
        Iterator<Entry<String, BaseSliderView>> it = sliderViews.entrySet().iterator();
        while(it.hasNext()){
